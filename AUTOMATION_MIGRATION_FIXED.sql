-- AUTOMATION SCHEMA MIGRATION - FIXED VERSION
-- Run this SQL in your Supabase SQL Editor

-- First, let's check what tables already exist and drop them if needed
...
CREATE INDEX idx_sequence_steps_sequence_step ON sequence_steps(sequence_id, step_index);
CREATE INDEX idx_sequence_enrollments_business_id ON sequence_enrollments(business_id);
CREATE INDEX idx_sequence_enrollments_sequence_id ON sequence_enrollments(sequence_id);
CREATE INDEX idx_sequence_enrollments_customer_id ON sequence_enrollments(customer_id);
CREATE INDEX idx_sequence_enrollments_next_run_at ON sequence_enrollments(next_run_at);
...
CREATE INDEX idx_automation_logs_source ON automation_logs(source);
CREATE INDEX idx_automation_logs_sequence_id ON automation_logs(sequence_id);
