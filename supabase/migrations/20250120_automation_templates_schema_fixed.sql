...
-- FIXED: Works with existing schema using created_by instead of owner_id
...
-- Note: businesses and customers tables already exist
-- Just add missing columns to customers if they don't exist
