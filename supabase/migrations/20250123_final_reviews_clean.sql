-- FINAL CLEAN REVIEWS SETUP - Handles all existing objects
...
DROP FUNCTION IF EXISTS update_feedback_cases_updated_at() CASCADE;
DROP FUNCTION IF EXISTS create_feedback_case_from_review() CASCADE;
...
-- Step 4: Create indexes (with IF NOT EXISTS to prevent conflicts)
...
CREATE INDEX IF NOT EXISTS idx_feedback_cases_business_id ON public.feedback_cases(business_id);
CREATE INDEX IF NOT EXISTS idx_feedback_cases_review_id ON public.feedback_cases(review_id);
CREATE INDEX IF NOT EXISTS idx_feedback_cases_status ON public.feedback_cases(status);
CREATE INDEX IF NOT EXISTS idx_feedback_cases_assigned_to ON public.feedback_cases(assigned_to);
CREATE INDEX IF NOT EXISTS idx_feedback_cases_priority ON public.feedback_cases(priority);
CREATE INDEX IF NOT EXISTS idx_feedback_cases_follow_up_date ON public.feedback_cases(follow_up_date);
CREATE INDEX IF NOT EXISTS idx_feedback_cases_created_at ON public.feedback_cases(created_at DESC);
