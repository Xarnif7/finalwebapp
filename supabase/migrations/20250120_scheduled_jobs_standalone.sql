...
-- This is a standalone migration that doesn't depend on other tables

-- Create scheduled_jobs table without any foreign key constraints
CREATE TABLE IF NOT EXISTS scheduled_jobs (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  business_id UUID NOT NULL, -- Will add foreign key constraint later
