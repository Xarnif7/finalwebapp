-- Phase 1 Features Database Migration - FIXED VERSION
-- Extends existing Blipp app with new tables and columns

-- Enable necessary extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- 1. Review Requests Table (extend existing or create new)
CREATE TABLE IF NOT EXISTS review_requests (
    ...
    tech_id UUID NULL, -- Will add foreign key after techs table is created
    job_type TEXT NULL,
...
-- 3. Techs Table (create this first)
...
-- Now add the foreign key constraint for tech_id in review_requests
ALTER TABLE review_requests 
ADD CONSTRAINT fk_review_requests_tech_id 
