  ...
  return (
    <div className="px-6 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6 mb-8">
        <div className="relative overflow-visible rounded-2xl border border-slate-200 bg-white p-5 shadow-sm motion-safe:transition motion-safe:duration-200 motion-safe:ease-out motion-safe:hover:-translate-y-0.5 [--glow-from:#3B82F6] [--glow-to:#8B5CF6] after:pointer-events-none after:absolute after:-inset-0.5 after:rounded-[inherit] after:bg-[linear-gradient(90deg,var(--glow-from),var(--glow-to))] after:opacity-0 after:blur-sm after:transition-all after:duration-200 after:-z-10 hover:after:opacity-40 motion-reduce:transform-none motion-reduce:shadow-sm motion-reduce:hover:after:opacity-0">
