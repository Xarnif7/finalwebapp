-- Minimal Database Schema for Blipp Application
-- Run this in your Supabase SQL Editor

-- First, let's create just the essential tables without complex relationships
...
-- Create customers table (simple version)
...
-- Enable Row Level Security on basic tables
